...
extension Date {
    ...
    init(year : Int, month : Int, day : Int) {
        ...
        self = NSDate(timeInterval: 0, since: calendar.date(from: dateComponent)!) as Date
        
        //(self as NSDate).type(of: init)(timeInterval:0, since:calendar.date(from: dateComponent)!)
    }
